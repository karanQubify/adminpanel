...
<div class="header row">
    ...
    <div class="col-md-4 p-2 text-right"><a class="btn btn-success "
            href="{{ route('admin.service.create') }}"> Create New Service</a></div>
        ...
        @else
            @foreach($services as $service)
                <tr id="{{ $service->id }}">
                    ...
                    <td><img src="{{ asset($service->icon) }}" alt="Technology Icon" height="50" width="50" ></td>
                    <td>
                        <a href="{{ route('admin.service.edit', ['service' => $service->id]) }}"
                            class="text-info m-3">
                            <i class="fas fa-edit"></i>
                        </a>
                        <i class="fas fa-trash text-danger delete_service" style="cursor: pointer;"
